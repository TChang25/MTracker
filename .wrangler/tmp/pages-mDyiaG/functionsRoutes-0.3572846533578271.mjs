import { onRequestGet as __api_allstreaks_ts_onRequestGet } from "C:\\Users\\Admin\\Desktop\\MTracker\\Mtracker\\functions\\api\\allstreaks.ts"
...
import { onRequestGet as __api_user_ts_onRequestGet } from "C:\\Users\\Admin\\Desktop\\MTracker\\Mtracker\\functions\\api\\user.ts"
...
export const routes = [
    {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_allstreaks_ts_onRequestGet],
    },
  {
      routePath: "/api/login",
      mountPath: "/api",
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_user_ts_onRequestGet],
    },
  {
